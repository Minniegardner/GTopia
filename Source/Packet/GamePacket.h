...
enum eTCPPacketType
{
    ...
    TCP_PACKET_CROSS_SERVER_ACTION,
...
enum eTCPCrossServerActionPacketType
{
    TCP_CROSS_ACTION_REQUEST = 1,
    TCP_CROSS_ACTION_EXECUTE = 2,
    TCP_CROSS_ACTION_RESULT = 3
};

enum eTCPCrossServerActionType
{
    TCP_CROSS_ACTION_MSG = 1,
    TCP_CROSS_ACTION_SUMMON = 2,
    TCP_CROSS_ACTION_SUSPEND = 3,
    TCP_CROSS_ACTION_UNSUSPEND = 4,
    TCP_CROSS_ACTION_KICK = 5,
    TCP_CROSS_ACTION_WARN = 6,
    TCP_CROSS_ACTION_SUPER_BROADCAST = 7,
    TCP_CROSS_ACTION_FRIEND_LOGIN = 8,
    TCP_CROSS_ACTION_FRIEND_LOGOUT = 9,
    TCP_CROSS_ACTION_FRIEND_REQUEST = 10,
    TCP_CROSS_ACTION_FRIEND_ACCEPT = 11,
    TCP_CROSS_ACTION_PBAN = 12,
    TCP_CROSS_ACTION_MAINTENANCE = 13,
    TCP_CROSS_ACTION_GIVEITEM = 14,
    TCP_CROSS_ACTION_WARPTO = 15,
    TCP_CROSS_ACTION_PINFO = 16,
    TCP_CROSS_ACTION_SUMMON_ALL = 17,
    TCP_CROSS_ACTION_SERVER_SWITCH = 18,
    TCP_CROSS_ACTION_GLOBAL_SFX = 19
};

enum eTCPCrossServerActionResult
{
    TCP_CROSS_ACTION_RESULT_OK = 0,
    TCP_CROSS_ACTION_RESULT_NOT_FOUND = 1,
    TCP_CROSS_ACTION_RESULT_MULTIPLE_MATCH = 2,
    TCP_CROSS_ACTION_RESULT_SELF_TARGET = 3,
    TCP_CROSS_ACTION_RESULT_SEND_FAILED = 4
};
